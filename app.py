import streamlit as st # V41.1 SYNC
import re
import pandas as pd
import time
import html
...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="NucleusX AI V41.1 LUXURY",
    page_icon="🗞️",
    layout="wide",
...
st.markdown("""
    ...
    * { font-family: 'Inter', sans-serif; box-sizing: border-box; }
    ...
    .category-column { 
        flex: 0 0 23.5% !important; /* Pushes the 5th column to be clearly cut off (~40-50%) */
...
header_html = f"""
    <div class="top-nav">
        <a href="/?page=home" target="_self" style="text-decoration: none; color: inherit;">
            <div class="logo-text">NUCLEUS<b>X</b> AI <small style="font-weight:400; font-size:0.6rem; opacity:0.6;">v41.1 Luxury</small></div>
        </a>
    </div>
"""
...
st.sidebar.markdown("---")
st.sidebar.caption("NucleusX v41.1 Luxury - Developed by Antigravity AI")
